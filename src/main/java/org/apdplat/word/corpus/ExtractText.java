...
public class ExtractText {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.corpus.ExtractText.class);
    ...
    private static void analyzeCorpus(String zipFile, String output, final String separator, final boolean includePhrase) throws IOException{
        ...
        try (FileSystem fs = FileSystems.newFileSystem(Paths.get(zipFile), org.apdplat.word.corpus.ExtractText.class.getClassLoader());

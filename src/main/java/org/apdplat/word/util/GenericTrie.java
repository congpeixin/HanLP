...
public class GenericTrie<V> {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.util.GenericTrie.class);
    ...
    public static void main(String[] args){
        org.apdplat.word.util.GenericTrie<String> trie = new org.apdplat.word.util.GenericTrie<>();
        trie.put("杨尚川", "nr");
        trie.put("杨尚喜", "nr");
        trie.put("人", "n");
        trie.put("写代码", "v");
        ...
        org.apdplat.word.util.GenericTrie<Integer> trie2 = new org.apdplat.word.util.GenericTrie<>();
        trie2.put("杨尚川", 100);
        trie2.put("杨尚喜", 90);
        trie2.put("人", 10);
        trie2.put("写代码", 80);

...
public class WordConfTools {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.util.WordConfTools.class);
    ...
    private static void loadConf(String confFile) {
        InputStream in = org.apdplat.word.util.WordConfTools.class.getClassLoader().getResourceAsStream(confFile);
        if(in == null){

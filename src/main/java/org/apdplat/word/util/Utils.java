 ...
 */
public class Utils {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.util.Utils.class);
    ...
    public static List<String> readResource(String resource){
        ...
        try {
            InputStream stream = org.apdplat.word.util.Utils.class.getResourceAsStream(resource);

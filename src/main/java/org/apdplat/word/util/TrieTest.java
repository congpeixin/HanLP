...
public class TrieTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.util.TrieTest.class);
    public static void testBigram() throws Exception{
        ...
        org.apdplat.word.util.DoubleArrayGenericTrie doubleArrayGenericTrie = new org.apdplat.word.util.DoubleArrayGenericTrie(WordConfTools.getInt("bigram.double.array.trie.size", 5500000));
    ...
    public static void testTrigram() throws Exception{
        ...
        org.apdplat.word.util.DoubleArrayGenericTrie doubleArrayGenericTrie = new DoubleArrayGenericTrie(WordConfTools.getInt("trigram.double.array.trie.size", 10100000));
        doubleArrayGenericTrie.putAll(map);
        map.keySet().forEach(key->assertEquals(map.get(key).intValue(), doubleArrayGenericTrie.get(key)));
        for(int i=0; i<1000; i++){
            map.keySet().forEach(key->doubleArrayGenericTrie.get(key));

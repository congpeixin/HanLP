...
public class ChineseWordAnalyzer extends Analyzer {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.lucene.ChineseWordAnalyzer.class);
    ...
    public static void main(String args[]) throws IOException {
        Analyzer analyzer = new org.apdplat.word.lucene.ChineseWordAnalyzer();

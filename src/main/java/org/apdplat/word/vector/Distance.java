...
public class Distance {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.vector.Distance.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        org.apdplat.word.vector.Distance distance = new org.apdplat.word.vector.Distance(new EditDistanceTextSimilarity(), model);

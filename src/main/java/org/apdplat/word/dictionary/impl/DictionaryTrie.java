...
public class DictionaryTrie implements Dictionary {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.dictionary.impl.DictionaryTrie.class);
    ...
    public static void main(String[] args){
        org.apdplat.word.dictionary.impl.DictionaryTrie trie = new org.apdplat.word.dictionary.impl.DictionaryTrie();
        trie.add("APDPlat");
        trie.add("APP");
        trie.add("APD");
        trie.add("杨尚川");

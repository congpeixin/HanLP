...
public final class DictionaryFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.dictionary.DictionaryFactory.class);
    private static final int INTERCEPT_LENGTH = WordConfTools.getInt("intercept.length", 16);
    private DictionaryFactory(){}
    public static final org.apdplat.word.dictionary.Dictionary getDictionary(){
    ...
    private static final class DictionaryHolder{
        private static final org.apdplat.word.dictionary.Dictionary DIC = constructDictionary();
        private static org.apdplat.word.dictionary.Dictionary constructDictionary(){
            try{
                ...
                return (org.apdplat.word.dictionary.Dictionary)Class.forName(dicClass.trim()).newInstance();

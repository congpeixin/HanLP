...
public class PartOfSpeechTagging {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.tagging.PartOfSpeechTagging.class);
    ...
    public static List<Term> process(List<Word> words){

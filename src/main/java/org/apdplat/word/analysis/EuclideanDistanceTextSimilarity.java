 ...
 * @author 杨尚川
 */
public class EuclideanDistanceTextSimilarity extends org.apdplat.word.analysis.TextSimilarity {
    /**
     * 判定相似度的方式：欧几里得距离
     * 欧几里得距离原理：
     * 设A(x1, y1)，B(x2, y2)是平面上任意两点
    ...
    public static void main(String[] args) {
        ...
        String text2 = "我爱读书";
        String text3 = "他是黑客";
        TextSimilarity textSimilarity = new org.apdplat.word.analysis.EuclideanDistanceTextSimilarity();

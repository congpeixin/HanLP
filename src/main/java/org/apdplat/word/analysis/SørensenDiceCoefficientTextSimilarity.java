 ...
 * @author 杨尚川
 */
public class SørensenDiceCoefficientTextSimilarity extends org.apdplat.word.analysis.TextSimilarity {
    /**
     * 计算相似度分值
     * @param words1 词列表1
     * @param words2 词列表2
    ...
    public static void main(String[] args) {
        ...
        String text2 = "我爱读书";
        String text3 = "他是黑客";
        TextSimilarity textSimilarity = new org.apdplat.word.analysis.SørensenDiceCoefficientTextSimilarity();

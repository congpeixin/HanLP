 ...
 * @author 杨尚川
 */
public class ManhattanDistanceTextSimilarity extends org.apdplat.word.analysis.TextSimilarity {
    /**
     * 判定相似度的方式：曼哈顿距离
     * 曼哈顿距离原理：
     * 设A(x1, y1)，B(x2, y2)是平面上任意两点
    ...
    public static void main(String[] args) {
        ...
        String text2 = "我爱读书";
        String text3 = "他是黑客";
        TextSimilarity textSimilarity = new org.apdplat.word.analysis.ManhattanDistanceTextSimilarity();

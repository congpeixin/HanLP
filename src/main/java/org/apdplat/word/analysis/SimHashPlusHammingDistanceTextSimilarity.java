...
public class SimHashPlusHammingDistanceTextSimilarity extends TextSimilarity {
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apdplat.word.analysis.SimHashPlusHammingDistanceTextSimilarity.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        String text2 = "我爱读书";
        String text3 = "他是黑客";
        TextSimilarity textSimilarity = new org.apdplat.word.analysis.SimHashPlusHammingDistanceTextSimilarity();
